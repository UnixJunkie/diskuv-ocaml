...
.. code-block:: shell-session
    ...
    [core_kernel.v0.14.2]$ opam update diskuv-0.1.0-prerel3
...
---------------------------------
    ...
    ``opam update diskuv-0.1.0-prerel3 && opam upgrade`` before doing any of these
...
.. code:: bash
    ...
    opam update diskuv-0.1.0-prerel3
...
If after ``opam update diskuv-0.1.0-prerel3`` you get:
...
then rerun the command as ``opam update diskuv-0.1.0-prerel3 -vv``. That will give you
something like:
...
.. code:: bash
    ...
    opam repository remove diskuv-0.1.0-prerel3 --all

    # On Windows do: ./make init-dev
    make init-dev

    opam repository priority diskuv-0.1.0-prerel3 1 --all
    opam update diskuv-0.1.0-prerel3
